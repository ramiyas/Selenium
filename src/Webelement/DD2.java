//WAS to check whether it is a singleselect or multiselect dropdown
package Webelement;
...
public class DD2 {
	...
	public static void main(String[] args) throws InterruptedException {
			...
			//System.out.println(s.s);
				...
				driver.close();
				//with ebay single select
				System.setProperty("webdriver.chrome.driver", "./Software/chromedriver.exe");
				WebDriver driver1=new ChromeDriver();
				driver1.get("https://www.ebay.com/");
				Thread.sleep(3000);
				WebElement ele1=driver1.findElement(By.id("gh-cat"));
				Select s1=new Select(ele1);
				if(s1.isMultiple())
				{
					System.out.println("fail"+""+" it is multiple selection dropdown");
				}
					else
				{
						System.out.println("pass"+" "+"it is not multiple selection dropdown");
				}
				driver1.close();
